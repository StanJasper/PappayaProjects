...
public class jeppiaar {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		WebDriverManager.chromedriver().setup();
		ChromeDriver driver = new ChromeDriver();
		driver.get("https://uatjeppiaararts.pappaya.com/application-form");
		driver.manage().window().maximize();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		//APPLICANT DETAILS
		driver.findElement(By.id("first_name")).sendKeys("ASHWIN KUMAR");
		driver.findElement(By.id("last_name")).sendKeys("S");
		driver.findElement(By.id("dob")).sendKeys("01012005");
		driver.findElement(By.id("mobile")).sendKeys("9988998899");
		driver.findElement(By.name("emailid")).sendKeys("ash@gmail.com");
		driver.findElement(By.id("critical_father_mobile")).sendKeys("7777666654");
		driver.findElement(By.id("critical_guardian_mobile")).sendKeys("6677666654");
	    ...
	    //PARENT DETAILS
	    driver.findElement(By.name("father_name")).sendKeys("Vishva");
		driver.findElement(By.id("father_number")).sendKeys("7777666654");
		driver.findElement(By.name("father_mail")).sendKeys("vish@gmail.com");
	    driver.findElement(By.name("mother_name")).sendKeys("Vani");
		driver.findElement(By.id("m_number")).sendKeys("7777666659");
		driver.findElement(By.name("m_mail")).sendKeys("vani@gmail.com");
        driver.findElement(By.name("guardian_name")).sendKeys("Vijay");
		driver.findElement(By.id("guardian_number")).sendKeys("6677666654");
		driver.findElement(By.name("guardian_mail")).sendKeys("vj@gmail.com");
		//CONTACT DETAILS
